    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
                                ...
                                <select style="width:100%" name="Dompet" class="text-center">
                                    <option value="<?php echo $db->Dompet + '0' ?>" selected>------ Pilih Jumlah Topup  ------</option>
                                    <option value="<?php echo $db->Dompet + '5000' ?>">Rp. <?php echo number_format('5000',0,",",".");?></option>
                                    <option value="<?php echo $db->Dompet + '10000' ?>">Rp. <?php echo number_format('10000',0,",",".");?>                  </option>
                                    <option value="<?php echo $db->Dompet + '15000' ?>">Rp. <?php echo number_format('15000',0,",",".");?></option>
                                    <option value="<?php echo $db->Dompet + '25000' ?>">Rp. <?php echo number_format('25000',0,",",".");?></option>
                                    <option value="<?php echo $db->Dompet + '50000' ?>">Rp. <?php echo number_format('50000',0,",",".");?></option>
                                    <option value="<?php echo $db->Dompet + '75000' ?>">Rp. <?php echo number_format('75000',0,",",".");?></option>
                                    <option value="<?php echo $db->Dompet + '100000' ?>">Rp. <?php echo number_format('100000',0,",",".");?></option>
                                </select>
