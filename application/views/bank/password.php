		...
		<div class="card shadow mb-4">
			<div class="tab-content">
				<ul class="nav nav-tabs">
					<li class="nav-item">
						<a class="nav-link" href="<?php echo base_url('bank/home/profil/')?>">Ubah
							Profil</a>
					</li>
					<li class="nav-item">
				...
				<?php echo form_open('bank/home/updatepassword/')?>
				<?php foreach ($sess as $row ){ ?>
				<div class="form-group">
					<label for="current_password" class="control-label col-sm-4">Password Saat ini</label>
					<div class="col-sm-6">
				...
				<div class="form-group">
					<label for="newpassword1" class="control-label col-sm-6">Password baru</label>
					<div class="col-sm-6">
				...
				<div class="form-group">
					<label for="new_password2" class="control-label col-sm-6">Ulangi password</label>
					<div class="col-sm-6">
