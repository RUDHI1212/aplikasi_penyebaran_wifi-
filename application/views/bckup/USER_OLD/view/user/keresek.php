...
<form action="<?php echo base_url()?>USER/home/ubah_cart" method="post" name="frmShopping" id="frmShopping" class="form-horizontal" enctype="multipart/form-data">
<?php
...
<tr>
<td><?php echo $i++; ?></td>
<td><img class="img-responsive" src="<?php echo base_url() . 'assets/user/images/'.$item['gambar']; ?>"/></td>
...
<td><a href="<?php echo base_url()?>USER/home/hapus/<?php echo $item['rowid'];?>" class="btn btn-sm btn-danger"><i class="glyphicon glyphicon-remove"></i></a></td>
<?php endforeach; ?>
</tr>
<tr>
...
<a href="<?php echo base_url()?>USER/home/check_out"  class ='btn btn-sm btn-primary'>Check Out</a>
</tr>
...
<?php
    ...
    {
      echo "<h3><i>'Keranjang Belanja Kosong..'</i></h3>";  
    } 
?>
</form>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-md">
      ...
      <div class="modal-content">
        <form method="post" action="<?php echo base_url()?>USER/home/hapus/">
