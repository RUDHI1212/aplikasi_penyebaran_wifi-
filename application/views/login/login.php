<div class="container">
	<!-- Outer Row -->
	<div class="vali-dasi" data-validasi="<?php echo $this->session->flashdata('validasi'); ?>"> </div>
		...
		<div class="col-xl-10 col-lg-12 col-md-9">
			<div class="card o-hidden border-0 shadow-lg my-5">
				<div class="card-body p-0">
					...
					<div class="row">
						<div class="col-lg d-none d-lg-block bg-model"></div>
						<div class="col-lg">

							<div class="p-5">
								<div class="text-center">
									<h1 class="h1 text-gray-700 mb-4">Welcome <br> Aplikasi Admin Sebaran Lokasi</h1>
								</div>
								...
								<form method="POST" action="<?= base_url()?>login/login">
									...
									<div class="form-group">
										<input id="username" name="username" type="text"
											class="form-control form-control-user" placeholder="NIS" value="<?php echo set_value('username')?>">
									...
									<button class="btn btn-primary btn-user btn-block" name="submit" id="btn-login"
										type="submit">
										Masuk
									</button>
									<a href="<?php echo base_url()?>auth" class="btn btn-danger btn-block ">Kembali</a>
