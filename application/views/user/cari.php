<section class="section-content bg padding-y-sm">
	<div class="container">
		<h2 class="text-muted text-center">Pencarian</h2>
		<hr>
...
?>
		...
		<form method="post" action="<?php echo base_url();?>USER/home/tambah" method="post" accept-charset="utf-8">
					...
					<div class="row">
						<aside class="col-sm-3">
							<div class="img-wrap"><img
									src="<?php echo base_url() . 'assets/user/images/'.$row->gambar; ?>"></div>
						</aside> <!-- col.// -->
						<article class="col-sm-6">
							...
							<dl class="dlist-align">
								<dt>qty</dt>
								<dd class="col-sm-3"><input type="number" class="form-control" name="qty" value="1" min="0"></dd>
							</dl> <!-- item-property-hor .// -->
						...
						<aside class="col-sm-3 border-left">
							<div class="action-wrap">
								...
								<br>
								<p>
									<button type="submit" class="btn btn-primary"></i> Tambah Ke Keranjang </button>
