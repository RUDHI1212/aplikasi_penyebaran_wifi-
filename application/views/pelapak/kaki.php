      ...
      <footer class="sticky-footer bg-white">
      	<div class="container my-auto">
      		<div class="copyright text-center my-auto">
      			<span>Copyright &copy; CAGON || CANTEEN GO ONLINE</span>
      		</div>
      	</div>
      </footer>
      <!-- End of Footer -->
      	...
      	<div class="modal-dialog" role="document">
      		<div class="modal-content">
      			<div class="modal-header">
      				<h5 class="modal-title" id="exampleModalLabel">Beneran nih mau logout?</h5>
      				<button class="close" type="button" data-dismiss="modal" aria-label="Close">
      					<span aria-hidden="true">×</span>
      				</button>
      			</div>
      			<div class="modal-body">Ketika kamu logout maka kamu akan keluar dari akun
      ...
      <script src="<?php echo base_url()?>assets/sweetalert/scriptpelapak.js"></script>
      ...
      <!-- Page level plugins -->
      <script src="<?php echo base_url()?>assets/bootstrap3/vendor/chart.js/Chart.min.js"></script>
