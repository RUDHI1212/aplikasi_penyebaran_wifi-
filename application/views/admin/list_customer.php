    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?php echo base_url('ADMIN/home/hapuscustomer/'.$data->id_user); ?>"> Hapus</a>
        </div>
      </div>
    </div>
  </div>
   ...
   <div class="modal fade" id="ubahCS<?= $data->id_user;?>" tabindex="-1" role="dialog" aria-labelledatay="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <?php echo form_open('ADMIN/home/updatecustomer/'.$data->id_user, ['method' => 'post']); ?>
