		...
		<div class="form-input clearfix">
			<div class="col-md-12">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<?php echo form_open('ADMIN/home/updatecustomer/'.$db->id_user, ['class' => 'form-horizontal', 'method' => 'post']); ?>
            <input type="hidden" class="form-control" name="id_user" value="<?php echo set_value('id_user', $db->id_user); ?>">
							...
							<div class="form-group">
                                ...
                                <div class="form-group">
								<label for="price" class="control-label col-sm-2">Kelas</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="kelas" value="<?php echo set_value('kelas', $db->kelas); ?>" required>
								</div>
							</div>
                            <div class="form-group">
								<div class="btn-form col-sm-12">
									<a href="<?php echo base_url('ADMIN/home/customer'); ?>"><button type="button" class='btn btn-default'>Batal</button></a>
